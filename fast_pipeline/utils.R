...
go_enrich <- function(gene_all_etz_i,allGO2genes,annFUN.GO2genes,selection,ontology="BP",topNodes=20){
    ...
    goEnrichment <- GenTable(go_data, KS=results.ks, orderBy="KS", topNodes=topNodes)
